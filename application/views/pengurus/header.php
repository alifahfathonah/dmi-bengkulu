                        ...
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <!-- <li class="nav-item dropdown">
                                ...
                                <div role="menu" class="dropdown-menu message-dd task-dd animated zoomIn">
                                    ...
                                    <div class="hd-mg-va">
                                        <a href="<?= base_url('pengurus/pesan') ?>">Lihat Semua</a>
                                    </div>
                                </div>
                            </li>
 -->                            <li class="nav-item">
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                <li><a href="<?= base_url('pengurus') ?>">Manajemen Masjid</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li <?php if($menu=="masjid") echo 'class="active"' ?>><a href="<?= base_url('pengurus') ?>"><i class="notika-icon notika-windows"></i> Manajemen Masjid</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal fade" id="myModalubahpassword" role="dialog">
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                <form action="<?= base_url('pengurus/ubahpassword') ?>" method="post">  
