                                                ...
                                                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="nk-int-st bootstrap-select">
                                                        <select name="tipologi" class="selectpicker" placeholder="Pilih Tipologi">
                                                            ...
                                                            <option <?php if(isset($masjid) && $masjid->tipologi=='Umum') echo 'selected' ?> value="Umum">Masjid Umum</option>
                                    ...
                                    <div class="form-example-int form-horizental">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="nk-int-st">
                                                        <input name="foto_sampul" type="file" class="form-control input-sm" placeholder="Upload Foto Sampul Masjid" value="<?php if(isset($masjid)) echo $masjid->foto ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
