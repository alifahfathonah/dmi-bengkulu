                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <a href="<?= base_url('admin/detailberita') ?>" class="pull-right btn btn-lg btn-success notika-btn-success">Tambah Berita</a>
                            <h2>Berita</h2>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/detailberita/'.$row->id) ?>" class="btn btn-sm btn-default" data-toggle="tooltip" title="Ubah"><i class="fa fa-pencil"></i></a>
                                            <a href="<?= base_url('admin/hapusberita/'.$row->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
