            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown <?php if($menu=="profil") echo 'active' ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil DMI<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                      <li><a class="page-scroll" href="#sejarah">Sejarah</a></li>
                      <li><a class="page-scroll" href="#visimisi">Visi Misi</a></li>
                      <li><a class="page-scroll" href="#motto">Motto</a></li>
                      <li><a class="page-scroll" href="#kepengurusan">Kepengurusan</a></li>
                      <li><a class="page-scroll" href="#berita">Berita</a></li>
                      <li><a class="page-scroll" href="#hubungikami">Hubungi Kami</a></li>
                    </ul> 
                  </li>
                  ...
                  <li class="dropdown <?php if($menu=="khutbah") echo 'active' ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Khutbah<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
